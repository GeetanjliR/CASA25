...
![Application Overview](images/Intro.jpg)
...
This code is intended to help visualise the occurrence of fires during and after the earthquake (end of December 2023 to early January 2024) and the areas that may have caused damage to buildings. The map visualisation highlights the immediate area affected by the fires and the extent of damage caused to buildings to help us identify areas where buildings may have been damaged as a result of the fires. Fire data points for this precise time were obtained by sending an email request to NASA. The code is divided into damaged building identification and fire affected areas.
...
![Pixelwise t-test, 2024](images/fire.jpg)
...
![Assumptions: Flood levels](images/Tsunami.jpg)
...
- Earth Engine Apps | Google Earth Engine [WWW Document], n.d. . Google for Developers. URL
    https://developers.google.com/earth-engine/guides/apps (accessed 4.21.24).
- Gärtner, P., 2024. philippgaertner/awesome-earth-engine-apps.
- Japan West Buildings footprint. Noto Earthquake January 2024 - Humanitarian Data Exchange [WWW Document], n.d. URL
    https://data.humdata.org/dataset/open_buildings_v3_west_japan_earthquake_epicenter? (accessed 4.22.24).
